// Questions data
const questions = [
    { id: 1, question: 'What is the boiling point of water at sea level?', options: ['90°C', '100°C', '120°C', '150°C'], answer: 2 },
    { id: 2, question: 'Which of the following is a renewable resource?', options: ['Coal', 'Oil', 'Wind', 'Natural Gas'], answer: 3 },
    { id: 3, question: 'What planet is known as the "Red Planet"?', options: ['Earth', 'Mars', 'Jupiter', 'Saturn'], answer: 2 },
    { id: 4, question: 'Which gas is most abundant in Earth’s atmosphere?', options: ['Oxygen', 'Hydrogen', 'Nitrogen', 'Carbon Dioxide'], answer: 3 },
    { id: 5, question: 'What is the chemical symbol for water?', options: ['H2O', 'O2', 'CO2', 'NaCl'], answer: 1 },
    { id: 6, question: 'Which organ in the human body is responsible for pumping blood?', options: ['Lungs', 'Liver', 'Brain', 'Heart'], answer: 4 },
    { id: 7, question: 'What is the main source of energy for life on Earth?', options: ['Moon', 'Earth’s core', 'Sun', 'Stars'], answer: 3 },
    { id: 8, question: 'Which of the following is a non-metal?', options: ['Iron', 'Copper', 'Sulfur', 'Aluminum'], answer: 3 },
    { id: 9, question: 'Which part of the plant conducts photosynthesis?', options: ['Root', 'Stem', 'Leaf', 'Flower'], answer: 3 },
    { id: 10, question: 'What is the atomic number of oxygen?', options: ['6', '7', '8', '9'], answer: 3 }
];
...
function confirmQuit() {
    ...
    if (userConfirmation) {
        ...
        window.location.href = "../../Subject Server/Science/ScienceMain.html"; // Redirect to an exit page or any action you'd like
    }
}
